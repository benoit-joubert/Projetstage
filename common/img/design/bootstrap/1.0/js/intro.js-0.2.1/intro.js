...
(function () {
  ...
  function _showElement(targetElement) {
    ...
    if(oldHelperLayer != null) {
	  ...
	  nextTooltipButton.className = "introjs-nextbutton btn btn-info";
      nextTooltipButton.href = "javascript:void(0);";
      nextTooltipButton.innerHTML = "Suivant &rarr;";
	  ...
	  prevTooltipButton.className = "introjs-prevbutton btn btn-info";
      prevTooltipButton.href = "javascript:void(0);";
      prevTooltipButton.innerHTML = "&larr; Précédent";

      //skip button
      var skipTooltipButton = document.createElement("a");
      //skipTooltipButton.className = "introjs-button introjs-skipbutton";
	  skipTooltipButton.className = "introjs-skipbutton btn btn-info";
      skipTooltipButton.href = "javascript:void(0);";
      skipTooltipButton.innerHTML = "Passer";
