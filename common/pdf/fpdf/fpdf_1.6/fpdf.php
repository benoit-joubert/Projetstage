...
var $pageEnTrop;        // ajout JC MARIN pour probleme avec sommaire.
var $errorMode = 'die'; // Ajout JC MARIN pour indiquer si on die ou exception quand erreur
/*******************************************************************************
*                                                                              *
*                               Public methods                                 *
*                                                                              *
...
// les 2 derniers parametres ne sont pas utilisé.
...
function _putpages()
{
	...
	if(!empty($this->AliasNbPages))
	{
		...
		for($n=1;$n<=$nb;$n++)
		{
		    $nbf = $nb-$this->pageEnTrop;
			$this->pages[$n]=str_replace($this->AliasNbPages,$nbf,$this->pages[$n]);
		}
	}
