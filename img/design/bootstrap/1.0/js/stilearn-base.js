$(function(){
    ...
    +'        <li><a id="fixedtop-mode" href="#fixedtop-mode">Fixer la barre du haut</a></li>'
    +'        <li><a id="fixedside-mode" href="#fixedside-mode">Fixer la barre du haut & le menu de gauche</a></li>'
    +'        <li><a id="fixedsideonly-mode" href="#fixedsideonly-mode">Fixer le menu de gauche</a></li>'
    +'    </ul>'
    +'    <div class="navigate-mode"><a href="#" class="grd-purple-dark corner-bottom"><i class="typicn-cog color-white"></i></a></div>'
    +'</div>';
